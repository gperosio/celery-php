...
abstract class CeleryAbstract
{
    ...
    {
        $defaultValues = ["host" => "", "login" => "", "password" => "", "vhost" => "", "exchange" => "celery", "exchange_type" => "direct", "binding" => "celery", "port" => 5672, "connector" => false, "persistent_messages" => false, "result_expire" => 0, "ssl_options" => []];

        $returnValue = [];

        foreach (['host', 'login', 'password', 'vhost', 'exchange', 'exchange_type', 'binding', 'port', 'connector', 'persistent_messages', 'result_expire', 'ssl_options'] as $detail) {
